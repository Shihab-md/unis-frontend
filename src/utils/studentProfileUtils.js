...
export const calculateAge = (dateOfBirth, asOf = new Date()) =>
  calculateCalendarDuration(dateOfBirth, asOf);

export const formatCompactDuration = (startDate, tr = (text) => text, asOf = new Date()) => {
...
export const formatCompactAge = (dateOfBirth, tr = (text) => text, asOf = new Date()) =>
  formatCompactDuration(dateOfBirth, tr, asOf);
