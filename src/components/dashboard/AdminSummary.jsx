...
const AdminSummary = () => {
  ...
  //p-6
  return (
    <div className="p-7 pl-3 items-center rounded-lg">
      ...
      <h5 className="text-xl mt-3 mb-7 font-bold text-center text-gray-500 text-shadow-lg">Super Admin Dashboard</h5>
