...
const View = () => {
  ...
  const handleDownload = () => {
    if (certificate.certificate) {
      ...
      link.download = certificate.templateId.code + "_" + certificate.code + ".jpg" || 'downloaded_image'; // Use provided name or default
            ...
            <div className="py-2 px-4 border mt-5 mb-1 items-center justify-center rounded-lg shadow-lg">
              ...
              <div>
                ...
                <div className="flex space-x-3 mb-5">
                  ...
                  <p className="font-normal">{certificate.templateId.code}</p>
                </div>
                <div className="flex space-x-3 mb-5">
