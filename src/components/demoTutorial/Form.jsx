...
const Form = () => {
  ...
  if (loading) {
    return <div className="mx-auto mt-6 max-w-4xl rounded-lg border bg-white p-8 text-center text-sm text-slate-500 shadow">{tr("Loading...")}</div>;
  }

  return (
    <div className="mx-auto mt-2 max-w-4xl p-3 md:p-5" dir={direction} style={{ fontFamily }}>
